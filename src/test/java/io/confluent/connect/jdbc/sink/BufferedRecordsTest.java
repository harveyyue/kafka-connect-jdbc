...
public class BufferedRecordsTest {
  ...
  public void correctBatching() throws SQLException {
    ...
    final JdbcBufferedRecords buffer = new JdbcBufferedRecords(config, tableId, dbDialect, dbStructure, sqliteHelper.connection);
  ...
  public void testFlushExecuteFailed() throws SQLException {
    ...
    final TableId tableId = new TableId(null, null, "dummy");
    final JdbcBufferedRecords buffer = new JdbcBufferedRecords(config, tableId, dbDialect,
  ...
  public void testInsertModeUpdate() throws SQLException {
    ...
    final TableId tableId = new TableId(null, null, "dummy");
    final JdbcBufferedRecords buffer = new JdbcBufferedRecords(config, tableId, dbDialect, dbStructureMock,
            connectionMock);
